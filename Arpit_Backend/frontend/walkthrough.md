...
Before modifying the CRQ frontend, the actual bank site's CSS (`banking_website/src/App.css`) was inspected. The design language defines the following variables:
